...
echo ""
echo "Start Spark integration deployment:"
echo "  docker compose -f docker-compose.spark.yml up -d"
echo ""
echo "Run Spark integration test (Docker mode):"
echo "  docker compose -f docker-compose.spark.yml --profile test run --rm spark-test"
